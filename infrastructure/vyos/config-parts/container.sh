...
set container name bind network services address '192.168.5.2'
...
set container name haproxy-k8s-api network containers address '192.168.5.3'
...
set container name omada-controller network containers address '192.168.5.4'
