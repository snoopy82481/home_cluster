...
set service dhcp-server shared-network-name TRUSTED subnet 192.168.50.0/24 static-mapping  ip-address '192.168.50.'
set service dhcp-server shared-network-name TRUSTED subnet 192.168.50.0/24 static-mapping  mac-address ''
set service dhcp-server shared-network-name TRUSTED subnet 192.168.50.0/24 static-mapping  ip-address '192.168.50.'
set service dhcp-server shared-network-name TRUSTED subnet 192.168.50.0/24 static-mapping  mac-address ''
set service dhcp-server shared-network-name TRUSTED subnet 192.168.50.0/24 static-mapping  ip-address '192.168.50.'
set service dhcp-server shared-network-name TRUSTED subnet 192.168.50.0/24 static-mapping  mac-address ''
